...
import { db } from '@/db';
import { mcpServersTable, profilesTable, projectsTable,resourcesTable } from '@/db/schema'; // Import necessary tables
import { getAuthSession } from '@/lib/auth'; // Import the correct auth helper
